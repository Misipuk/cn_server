...
def fill_reviews(reviews: Reviews):
    r1 = Review('PanAleha', 3, 5, now(), 'Tasty ribka', )
    r2 = Review('PanAleha', 1, 3, now(), 'Guys, pirozhki are incredible!', )
    r3 = Review('VasyaPupkin', 1, 5, now(), 'Meat pizza is the best', )
    r4 = Review('VasyaPupkin', 2, 5, now(), 'They have singing duck, this evening was nice)))', )
    r5 = Review('LesyaSuper', 2, 2, now(), 'Slow serving', )
    r6 = Review('LesyaSuper', 3, 1, now(), 'It is karas!!!', )
    r7 = Review('MrMops', 3, 5, now(), 'Delicious food', )
    r8 = Review('MrMops', 1, 4, now(), 'Pirozhok was cold, but tasty', )
    reviews.put(r1)
    reviews.put(r2)
    reviews.put(r3)
    reviews.put(r4)
